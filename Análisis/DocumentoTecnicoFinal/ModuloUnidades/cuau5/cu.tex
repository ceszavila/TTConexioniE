\begin{UseCase}{CUAU-5}{Gestionar Unidades de Aprendizaje}
	{
		...
		\UCitem{Tipo}{Primario, viene de \cdtIdRef{IUPA}{Pantalla Principal del administrador}}
		%	\UCitem{Fuente}{
		%	    \begin{UClist}
	...
	\UCExtensionPoint
	{El actor requiere editar una unidad de aprendizaje tocando el nombre de la misma}
	{ Paso \ref{CUU5.4:uaRegistrar} de la trayectoria principal}
	{\cdtIdRef{CUAU-5.2}{Editar Unidad de Aprendizaje}}
