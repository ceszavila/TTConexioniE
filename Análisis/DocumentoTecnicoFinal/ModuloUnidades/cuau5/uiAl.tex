...
\begin{itemize}
	...
	\item Botón \botCursos, dirige a la pantalla \cdtIdRef{IUCC-8}{Consultar convocatoria de curso}
	\item Botón \botMovilidad, dirige a la pantalla \cdtIdRef{IUCM-8.1}{Consultar convocatoria de movilidad}
\end{itemize}
