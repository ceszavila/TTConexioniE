...
\begin{figure}[h!]
	\begin{center}
		\includegraphics[width=0.3\textwidth]{images/ModuloUnidades/IUAU5.png}
...
Finalizando esta etapa obteniendo las funcionalidades descritas anteriormente y que se muestran en las interfaces de usuario \cdtIdRef{IUAU-5}{Gestionar Unidades de Aprendizaje}, \cdtIdRef{IUAU-5.1}{Registrar Unidad de Aprendizaje}, \cdtIdRef{IUAU-5.2}{Editar Unidad de Aprendizaje}. \\
...
\begin{figure}[h!]
	\begin{center}
		\includegraphics[width=0.3\textwidth]{images/ModuloConvocatorias/IUAC7.png}
...
Finalizando esta etapa obteniendo las funcionalidades descritas anteriormente y que se muestran en las interfaces de usuario \cdtIdRef{IUAC-7}{Gestionar convocatorias de cursos}, \cdtIdRef{IUAC-7.1}{Registrar convocatoria de curso}, \cdtIdRef{IUAC-7.2}{Editar convocatoria de curso}, \cdtIdRef{IUAC-7.3}{Eliminar convocatoria de curso}. \\
 ...
 \begin{figure}[h!]
 	\begin{center}
 		\includegraphics[width=0.3\textwidth]{images/ModuloConvocatorias/IUCM8_1.png}
 ...
 Finalizando esta etapa obteniendo las funcionalidades descritas anteriormente y que se muestran en las interfaces de usuario \cdtIdRef{IUAC-7.4}{Gestionar convocatorias de movilidad}, \cdtIdRef{IUAC-7.5}{Registrar convocatoria de movilidad}, \cdtIdRef{IUAC-7.6}{Editar convocatoria de movilidad}, \cdtIdRef{IUAC-7.7}{Eliminar convocatoria de movilidad}, \cdtIdRef{IUCM-8.1}{Consultar convocatoria de movilidad}, \cdtIdRef{IUCM-8.1.1}{Consultar convocatoria nacional}, \cdtIdRef{IUCM-8.1.2}{Consultar convocatoria internacional} \\