...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% %%%%%%%%%%%%%%%%%%%%%%
% Datos del proyecto
\directores{Ulises Velez Saldaña}{José David Ortega Pacheco}
...
\proyecto{Presentado por:\\Cesar Raúl Avila Padilla\\Ivo Sebastián Sam Álvarez-Tostado}
\documento{C2--DA}{Documento Técnico del Trabajo Terminal II 2017-A108}{\RELEASE{1.0}}%{\DRAFT{\today}} 

\entregable{}{\Large{Aplicación Móvil para la Comunidad Estudiantil de la ESCOM  (Conexión iE)}}
...
%\IUfig[.3]{/carta}{IUPA}{Pantalla Principal Administrador}
%=========================================================
% Hoja de revisión
%\makeDocInfo
\newpage
...
%
%%---------------------------------------------------------------------
\chapter{Procesos}\label{chp:Procesos}
\cfinput{ModeloComportamiento/procesos}
