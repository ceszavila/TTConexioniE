...
\UCli \cdtRef{actor:CIEPrefectura}{Responsable Prefectura}
	...
	\UCitem{Tipo}{Primario, viene del menú \cdtIdRef{IUPA}{Pantalla Principal Administrador}}
%	\UCitem{Fuente}{
 \end{UseCase}

 \begin{UCtrayectoria}
    
    \UCpaso [\UCactor] Solicita gestionar los salones de la Escuela Superior de Cómputo tocando el botón \textbf{Administrar salones} de la pantalla \cdtIdRef{IUPA}{Pantalla Principal Administrador}.
    
    \UCpaso Obtiene el número de salón de todos los salones que se tienen registrados.
    
    \UCpaso \label{CUAS-03:Pantalla} Muestra la pantalla \cdtIdRef{IUAS-03}{Gestionar salones} 
    
    \UCpaso [\UCactor] Gestiona los salones.
\end{UCtrayectoria}
%
