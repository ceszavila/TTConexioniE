...
%    La figura \ref{fig:ModulosPAEAR} muestra los módulos que conforman el \saear. Cada uno de estos módulos agrupan los casos de uso que poseen funcionalidad similar o que trabajan en conjunto para alcanzar un aspecto funcional del sistema. Cada uno de los módulos que se muestran en la figura se describen a continuación:
    ...
    \begin{itemize}
	\item {\bf Consulta de grupos:} Agrupa los casos de uso que se relacionan con los salones asociados a los grupos al incio de cada periodo escolar. 
...
%--------------------------------------------------------------------------------------------------
    \begin{actor}{Alumno}{usuarioEscuela}{Persona inscrita dentro del Instituto Politécnico Nacional que solicitará las consultas de espacios, salones asignados a grupos, información sobre los trámites de la escuela y sobre el material de apoyo de las unidades de aprendizaje.}
...
%--------------------------------------------------------------------------------------------------
\begin{actor}{Visitante}{usuarioSMAGEM}{Persona externa al Instituto que desee localizar algún espacio o profesor para asesorías de investigación, consultas de especialidad para tésis, trámites, etc.}
...
La figura \ref{fig:casosUso:comite} muestra los casos de uso que integran la funcionalidad necesaria para la obtención de la información base para los indicadores ambientales y de sustenteabilidad de la escuela y que se refieren al registro y modificación de su información.
 ...
 \begin{figure}[h!]
     \begin{center}
         \fbox{\includegraphics[angle=90, height=0.9\textheight]{images/CasosUso/informacionBase.jpg}}
