...
%--------------------------------------------------------------------------------------------------
\begin{actor}{Responsable UTEC}{CIEUtec}{Persona perteneciente al Instituto encargada de proporcionar información de convocatorias sobre Tecnología Educativa y Campus Virtual.}
	...
	\begin{itemize}
		...
		\item Proporcionar la información que se tenga para convocatorias de cursos y certificaciones en la ESCOM.
...
%--------------------------------------------------------------------------------------------------
\begin{actor}{Responsable UPIS}{CIEUpis}{Persona perteneciente al Instituto que tiene la tarea de llevar al cabo las acciones que permitan poner al servicio de la sociedad las capacidades del Instituto, promover e impulsar en los diferentes sectores, escuelas, centros y unidades del IPN las actividades de vinculación, investigación, desarrollo y transferencia de tecnología, servicios técnicos y cursos de actualización profesional vinculados con las necesidades del entorno socioeconómico.}
	...
	\begin{itemize}
		...
		\item Proporcionar la información que se tenga para convocatorias de movilidad por semestre.
		\item Proporcionar información sobre las universidades participantes en el proceso de movilidad tanto nacional como internacional.
		\item Proporcionar información sobre los resultados de los participantes a movilidad estudiantil en el periodo escolar.
		\item Mantener actualizada la información.
...
%--------------------------------------------------------------------------------------------------
\begin{actor}{Responsable Coordinación de Cooperación Académica }{CIECca}{Persona perteneciente al Instituto encargada de dar a conocer la información sobre el trámite de movilidad académica.}
...
%--------------------------------------------------------------------------------------------------
\begin{actor}{Responsable EE}{CIEEstructura}{Persona encargada que proporcionar la información de las unidades de aprendizaje.}
...
%--------------------------------------------------------------------------------------------------
\begin{actor}{Responsable Prefectura}{CIEPrefectura}{Persona perteneciente al Instituto encargada de asignar los salones a los grupos que se abren cada Periodo Escolar.}
...
%--------------------------------------------------------------------------------------------------
\begin{actor}{Responsable Recursos Materiales}{CIERecursos}{Persona perteneciente al Instituto encargada de administrar los recursos que tiene la escuela así como la infraestructura de ella.}
...
%====================================================================================
\section{Casos de Uso del módulo Conexión iE Administrador }
