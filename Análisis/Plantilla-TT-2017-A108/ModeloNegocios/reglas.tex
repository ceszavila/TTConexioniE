...
\begin{BusinessRule}{RN-S2}{Información correcta}
	{Restricción}
	{Controla la operación}
	\BRitem{Descripción}{
		Todos los datos proporcionados al sistema deben respetar el formato y pertenecer al tipo de dato 
...
\begin{BusinessRule}{RN-S3}{Formato de fecha correcto}
	{Restricción}
	{Controla la operación}
	\BRitem{Descripción}{El formato del ingreso de fechas no debe exceder el número 28, 29, 30 o 31 dependiendo del mes en caso de ingresar un día y el número 12 en caso de ser ingresado un mes.}
\end{BusinessRule}
%------------------------------------------------------------------------------------------------------------------
...
\subsection{Reglas derivadas del negocio}
 ...
 \begin{BusinessRule}{RN-N1}{Fecha correcta de convocatorias}
 	{Restricción}
 	{Controla la operación}
 	\BRitem{Descripción}{La fecha ingresada para convocatoria de cursos y movilidad debe ser mayor a la fecha de inicio del periodo escolar actual y menos a la fecha de término del periodo escolar actual.}
 	\end{BusinessRule}
