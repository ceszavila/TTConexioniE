\begin{UseCase}{CU-05}{Consultar Detalle de Profesor}
    {
	Este caso de uso le permite al \textbf{Actor (Visitante y Alumno)} conocer la información que el profesor debe tener dispobible para su consulta pública. Cuando el actor desea saber los horarios del profesor, su correo institucional, donde encontrarlo, etc., podrá hacerlo mediante el detalle de la consulta
