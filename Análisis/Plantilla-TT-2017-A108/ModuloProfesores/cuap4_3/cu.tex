...
%			\end{UClist}
	...
	\begin{UCtrayectoria}
		...
		\UCpaso[\UCactor] Presiona el botón \cdtButton{Eliminar} de la pantalla \cdtIdRef{IUAP-4.2}{Editar Profesor}.\label{CUAP4.2:Editar3} \refTray{A}
		\UCpaso[\UCsist] Elimina al profesor del sistema.
		\UCpaso[\UCsist] Construye el mensaje \cdtIdRef{MSG01}{Operación exitosa} con los valores \textit{Valor= El profesor y OPERACIÓN = editó, por favor oprima el botón atrás}.
...
%		\UCpaso[\UCsist] Ejecuta el caso de uso \cdtIdRef{CUPM-02}{Consultar Detalles de Profesor}
	...
	\end{UCtrayectoria}
		...
		\begin{UCtrayectoriaA}[Fin del caso de uso]{A}{El actor presiona el botón \cdtButton{Editar}.}
		\UCpaso[\UCsist] Se ejecuta el caso de uso \cdtIdRef{CUAP-4.2}{Editar Profesor}
	\end{UCtrayectoriaA}
