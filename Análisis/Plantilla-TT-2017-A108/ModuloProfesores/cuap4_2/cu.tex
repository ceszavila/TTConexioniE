\begin{UseCase}{CUAP-4.2}{Editar Profesor}
	{
		Este caso de uso le permite al \cdtRef{actor:CIEProfesor}{Responsable de Profesores} editar la información de los profesores de la Escuela Superior de Cómputo. Esto con la finalidad de compartir la información con los alumnos.
		...
		\UCitem{Propósito}{Modificar la información de los profesores que imparten clases en la Escuela Superior de Cómputo.}
		\UCitem{Entradas}{
			        \begin{UClist} 
		...
		Modificará la información del profesor en el sistema.
		}
		\UCitem{Reglas de negocio}{
			\begin{UClist}
				       \UCli \cdtIdRef{RN-S1}{Campos Obligatorios}.
			\end{UClist}
		}
		\UCitem{Errores}{
			\begin{UClist}
	...
	\begin{UCtrayectoria}
		...
		\UCpaso[\UCsist] Muestra la pantalla \cdtIdRef{IUAP-4.2}{Editar Profesor}. junto con los botones \cdtButton{Editar} y \cdtButton{Eliminar}. \refTray{A}
		...
		\UCpaso Presiona el botón \cdtButton{Editar} de la pantalla \cdtIdRef{IUAP-4.2}{Editar Profesor}.\label{CUAP4.1:Editar3} \refTray{B}
		\UCpaso[\UCsist] Reemplaza la fotografía por default con la fotografía seleccionada por el actor.
		\UCpaso[\UCsist] Verifica que no se omitan datos marcados como obligatorios como se indica en la regla de negocios \cdtIdRef{RN-S1}{Datos Obligatorios}. \refTray{C}
...
%		\UCpaso[\UCsist] Ejecuta el caso de uso \cdtIdRef{CUPM-02}{Consultar Detalles de Profesor}
	...
	\begin{UCtrayectoriaA}[Fin del caso de uso]{A}{El actor presiona el botón \cdtButton{Eliminar}.}
		\UCpaso[\UCsist] Ejecuta el caso de uso \cdtIdRef{CUAP-4.3}{Eliminar profesor}
	\end{UCtrayectoriaA}
