...
\autor[]{Directores:}
\sistema[AMCEE]{Aplicación Móvil para la Comunidad Estudiantil de la ESCOM (Conexión iE)}
\proyecto[2017-A108]{Presentado por:\\Cesar Raúl Avila Padilla\\Ivo Sebastián Sam Álvarez-Tostado}
\documento{C2--DA}{Documento Técnico del Trabajo Terminal I 2017-A108}{\RELEASE{1.0}}%{\DRAFT{\today}} 
