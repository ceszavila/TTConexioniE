\begin{UseCase}{CU-01}{Consultar Edificio}
    {
	Este caso de uso le permite al \textbf{Actor (Visitante y Alumno)} localizar un edificio dentro de la Escuela Superior de Cómputo y obtener las vistas necesarias para llegar a su destino. 
...
%			\UCli {\bf Interna:} El sistema debe tener asociados los espacios a los grupos por periodo escolar.
	...
	\UCitem{Postcondiciones}{
	    \begin{UClist}
		\UCli {\bf Externa:} Los alumnos podrán saber en el momento que lo necesiten, el edificio en donde se encuentre el salón que fue asignado a su grupo sin tener que buscar las hojas de asignación de salones.
   	    \end{UClist}
	}
