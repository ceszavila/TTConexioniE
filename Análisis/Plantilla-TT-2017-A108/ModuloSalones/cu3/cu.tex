\begin{UseCase}{CU-03}{Consultar Salón}
    {
	Este caso de uso le permite al actor localizar un espacio dentro de la Escuela Superior de Cómputo y obtener las vistas necesarias para llegar a su destino. 
...
\UCli \cdtRef{actor:CIEVisitante}{Visitante}
	...
	\UCitem{Salidas}{
		\begin{UClist} 
			...
			\UCli Vista por niveles
			\UCli Vista de salones por nivel
		\end{UClist}	
	}
