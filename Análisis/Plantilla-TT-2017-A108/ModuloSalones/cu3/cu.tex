...
%	\UCitem{Fuente}{
 ...
 \begin{UCtrayectoria}
    ...
    \UCpaso[\UCsist] Muestra la pantalla \cdtIdRef{IUSM-01}{Consultar Asignación de Grupos} con la información obtenida en el paso \ref{CUMS-01:info}. \label{CUMS-01:salon}
