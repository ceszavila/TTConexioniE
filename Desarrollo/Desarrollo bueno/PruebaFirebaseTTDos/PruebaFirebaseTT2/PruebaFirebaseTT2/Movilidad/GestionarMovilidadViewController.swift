    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        case "editarNacional"?:
            if let indexpath = self.nacionaltbl.indexPathForSelectedRow{
                ...
                let destinationViewController = segue.destination as! EditarMovilidadNacionalViewController
                destinationViewController.movilidadNacional = movilidadNacionalSeleccionada
            }
        case "editarInternacional"?:
                ...
                if let indexpath = self.internacionaltbl.indexPathForSelectedRow{
                    ...
                    let destinaViewController = segue.destination as!   EditarMovilidadInternacionalViewController
                    destinaViewController.movilidadInternacionalEditar = movilidadInternacionalSeleccionada
                }
