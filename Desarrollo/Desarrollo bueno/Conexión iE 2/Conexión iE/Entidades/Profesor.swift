...
class Profesor: NSObject {
    ...
    init(nombre:String,fotografia:String, cubiculo:String,email:String,telefono:String,paginaWeb:String,horarioAtencion:String,academia:String,materias:String,trabajoTerminal:String){
        self.nombre = nombre
