...
\title{Mala comunicación entre la comunidad estudiantil de la Escuela Superior de Cómputo}
\author{Cesar Raúl Avila Padilla}
...
Sin embargo, no consiste en una verdadera multitarea, pues las aplicaciones ajenas al SO, quedan congeladas en segundo plano no recibiendo un solo ciclo de reloj del procesador.
 ...
 \begin{figure}[hbpt!]
 	...
 	\includegraphics[width=.5\textwidth]{iosgrafica}
 	\caption{Gráfica de uso de internet}
 	\label{fig:graficaandroid}
 	\includegraphics[width=.5\textwidth]{androidgrafica}
 \end{figure}
...
\begin{figure}
	...
	\includegraphics[width=.5\textwidth]{usuariosusaninternet}
	\caption{Usuarios iOS}
	\label{fig:grafica2usodeinternet}
	\includegraphics[width=.5\textwidth]{usodeinterte}
\end{figure}
...
\begin{figure}
	...
	\includegraphics[width=.5\textwidth]{usoencasa}
\end{figure}
